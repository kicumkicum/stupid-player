...
StupidPlayer.prototype.play = function(uri) {
	...
	this._emit(this.EVENT_START, this._isStream(uri));
...
StupidPlayer.prototype._makeDecoder = function(res) {
	...
	return new Promise(function(resolve, reject) {
		if (this._checkConnect(res)) {
			...
			this._onError('Is not correct url');
		}
	}.bind(this));
};
 ...
 * @protected
 */
StupidPlayer.prototype._checkConnect = function(res) {
	var result = false;
	try {
